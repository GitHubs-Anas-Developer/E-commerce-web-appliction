...
const createProduct = async (req, res) => {
    try {
      const { title, price, offerPrice, discountPercentage, about, description, subcategoryId } = req.body;
      ...
      const newProduct = new productModel({
        ...
        about,
        description,
        images: req.files.map((file) => file.path), // Map file paths to images array
